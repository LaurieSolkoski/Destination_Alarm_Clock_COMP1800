// when map is clicked, user is redirected to click on map page.
$("#map").click(function () {
...
//----------------------------
// Get radius from the slider (both click and touchend)
//----------------------------
function getRadius() {
  console.log(myradius);
  document
...
// directs user to alarm.html when alarm is set.
